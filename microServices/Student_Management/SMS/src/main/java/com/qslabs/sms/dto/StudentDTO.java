...
public class StudentDTO {
     ...
     */
    public StudentDTO(Long id,Long userId, String firstName, String lastName, LocalDate dateOfBirth, String gender, String address, String contactNumber, String nationality) {
        this.studentId = id;
        this.userId = userId;
